...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
	    ...
	    RequestDispatcher rd=request.getRequestDispatcher("EmployeeCrud.jsp"); // request dispatcher for jsp logic//
	    ...
	    else if(submit.contentEquals("Delete_Employee")) 
	    {
	    	if(edao.removeEmployee(e.getEmpid()))
	    		message=message+"Record Deleted";
	    	else
	    		message="Deleted Failed";
	    }                                     //for jsp part.. from else if//
